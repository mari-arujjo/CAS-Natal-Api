...
namespace api.Migrations
{
    ...
    [Migration("20250915225014_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.AppUserIdentity.Model.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("api.AppUserIdentity.Model.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Enrollments.Enrollment", b =>
                {
                    ...
                    b.HasOne("api.AppUserIdentity.Model.AppUser", "User")
                        .WithMany("Enrollments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
